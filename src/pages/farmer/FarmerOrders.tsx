...
const FarmerOrders = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await fetch("http://localhost:4002/api/orders/farmer", {
        headers: {
  ...
  const handleApprove = async (orderId: number) => {
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(`http://localhost:4002/api/orders/${orderId}/approve`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleReject = async (orderId: number) => {
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(`http://localhost:4002/api/orders/${orderId}/cancel`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleDownloadReport = async () => {
    try {
      ...
      const response = await fetch("http://localhost:4002/api/orders/farmer/download", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
